...
export const metadata: Metadata = {
  title: 'Woolahra | Call 0401 349 821 | Sydney Sliding Doors Repair - Cost Effective Sliding Door Repairs',
  description: 'Performing high qwuality sliding door repairs for clients located in the Woolahra Area.  Fast, friendly and professional service ',
}
                      ...
                      <div className="text">
                        ...
                        <div className="markdown prose w-full break-words dark:prose-invert light innex-box sd">
                          ...
                          <p>
                            ...
                            natural light, and easy access. That&apos;why we work tirelessly to restore
                          ...
                          <ul>
                            ...
                            <li>
                              ...
                              offer fast and reliable repair services to restore your door&apos;function as
                              quickly as possible.
                            </li>
                            <li>
                            ...
                            <li>
                              <strong>Comprehensive Repairs</strong>: Whether it&apos;a problem with the
                          ...
                          <p>
                            ...
                            spending a fortune. That&apos;why we offer affordable rates and a commitment to
